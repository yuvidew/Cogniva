                                                ...
                                                <FormControl>
                                                    <div className=" relative ">
                                                        <Input
                                                            ...
                                                            {...field}
                                                        />
                                                        <Button type="button" size={"icon"} variant={"default"} className=" bg-transparent hover:bg-transparent border-none outline-0 absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer" onClick={() => setIsConfirmEyeOpen(!isConfirmEyeOpen)}>
                                                            {isConfirmEyeOpen ? (
                                                                <EyeIcon className=" size-4  text-primary" />
                                                            ) : (
                                                                <EyeOffIcon className=" size-4 text-primary" />
